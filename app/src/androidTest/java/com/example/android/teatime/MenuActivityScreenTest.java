...
public class MenuActivityScreenTest {
    ...
    public void clickGridViewItem_OpensOrderActivity() {
        ...
        onData(anything()).inAdapterView(withId(R.id.tea_grid_view)).atPosition(3).perform(click());

        onView(withId(R.id.tea_name_text_view)).check(ViewAssertions.matches(withText("Oolong Tea")));
